    ...
    <div>
      ...
      <div class="bg-wrap">
        ...
        <div class="wrapper">
          ...
          <input type="button" value="注册" class="btn btn_login">
          <router-link to="/login">
            <input type="button" value="登录" class="btn btn_register">
          </router-link>
        </div>
